 ...
 */
public class PlaceholderFragmentAllPhotos extends Fragment {
    ...
    public static PlaceholderFragmentAllPhotos newInstance(int index) {
        PlaceholderFragmentAllPhotos fragment = new PlaceholderFragmentAllPhotos();
